...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rpmain/flexsearch.min.js');loadScript('/rpmain/en.search-data.min.78eb67e07214095a01644f35a8ccd5bb9651d87af58e1d6fd2512650141d43ca.js',function(){input.required=false;search();});}
